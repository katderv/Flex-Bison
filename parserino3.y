...
%token <strval> T_ELSE T_WHILE T_RETURN T_IF T_ANY T_SELF T_AS T_LAMBDA T_ELIF T_DICT T_OROP T_ANDOP T_EQUOP  T_RELOP
%token <strval> T_DEF T_INIT T_CLASS T_COLON T_FOR T_RANGE T_IN T_BOOL T_PRINT T_NOTOP T_DOT T_METH T_ID T_STRING
%token <strval> T_FROM T_CONTINUE T_BREAK T_DEFAULT T_LEN T_NEW  T_MAIN T_SIZEOP T_ERROR
...
if_stmt:
			...
			|T_IF expression T_COLON T_LINE tail T_ELIF expression T_COLON T_LINE tail		{printf("THIS IS AN IF-ELIF STATEMENT\n");}
			|T_IF expression T_COLON T_LINE tail T_ELIF expression T_COLON T_LINE tail T_ELSE T_COLON T_LINE tail {printf("THIS IS AN IF-ELIF-ELSE STATEMENT\n");}
			|T_IF expression T_COLON T_LINE tail T_ELSE T_COLON T_LINE tail	{printf("THIS IS AN IF-ELSE STATEMENT\n");}
			;						
